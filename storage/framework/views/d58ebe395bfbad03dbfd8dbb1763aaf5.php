...
<?php $__env->startSection('title', 'Создание изображения - ' . config('app.name')); ?>
<?php $__env->startSection('description', 'Добавление нового изображения в галерею'); ?>
...
<form id="image-form" action="<?php echo e(route('admin.gallery.store', $currentUserId)); ?>" method="POST" enctype="multipart/form-data" style="display: none;">
    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\link\resources\views/admin/gallery/create.blade.php ENDPATH**/ ?>