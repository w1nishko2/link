<form id="sectionsForm" 
      data-get-url="<?php echo e(route('admin.sections.get', $user->id)); ?>"
      data-update-url="<?php echo e(route('admin.sections.update', $user->id)); ?>"
...
</form><?php /**PATH C:\OSPanel\domains\link\resources\views/admin/profile/sections.blade.php ENDPATH**/ ?>