...
<?php $__env->startSection('title', 'Аналитика - ' . config('app.name')); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 flex-grow-1">
                            ...
                            <div class="stats-value"><?php echo e($stats['total_articles']); ?></div>
                            <div class="stats-subtext">
                                <span class="text-success"><?php echo e($stats['published_articles']); ?></span> опубликовано
                            </div>
                        </div>
                        <?php if(isset($growthStats['articles'])): ?>
                        <div class="stats-change <?php echo e($growthStats['articles']['change'] >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="bi bi-arrow-<?php echo e($growthStats['articles']['change'] >= 0 ? 'up' : 'down'); ?>"></i>
                            <?php echo e(abs($growthStats['articles']['change'])); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 flex-grow-1">
                            ...
                            <div class="stats-value"><?php echo e($stats['total_services']); ?></div>
                            <div class="stats-subtext">
                                <span class="text-success"><?php echo e($stats['active_services']); ?></span> активных
                            </div>
                        </div>
                        <?php if(isset($growthStats['services'])): ?>
                        <div class="stats-change <?php echo e($growthStats['services']['change'] >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="bi bi-arrow-<?php echo e($growthStats['services']['change'] >= 0 ? 'up' : 'down'); ?>"></i>
                            <?php echo e(abs($growthStats['services']['change'])); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 flex-grow-1">
                            ...
                            <div class="stats-value"><?php echo e($stats['total_gallery_images']); ?></div>
                            <div class="stats-subtext">
                                <span class="text-success"><?php echo e($stats['active_gallery_images']); ?></span> активных
                            </div>
                        </div>
                        <?php if(isset($growthStats['gallery'])): ?>
                        <div class="stats-change <?php echo e($growthStats['gallery']['change'] >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="bi bi-arrow-<?php echo e($growthStats['gallery']['change'] >= 0 ? 'up' : 'down'); ?>"></i>
                            <?php echo e(abs($growthStats['gallery']['change'])); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 flex-grow-1">
                            ...
                            <div class="stats-value"><?php echo e($stats['total_banners']); ?></div>
                            <div class="stats-subtext">
                                <span class="text-success"><?php echo e($stats['active_banners']); ?></span> активных
                            </div>
                        </div>
                        <?php if(isset($growthStats['banners'])): ?>
                        <div class="stats-change <?php echo e($growthStats['banners']['change'] >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="bi bi-arrow-<?php echo e($growthStats['banners']['change'] >= 0 ? 'up' : 'down'); ?>"></i>
                            <?php echo e(abs($growthStats['banners']['change'])); ?>
    ...
    <div class="row mb-4">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="progress flex-grow-1 me-3" style="height: 20px;">
                            <div class="progress-bar bg-gradient" 
                                 role="progressbar" 
                                 style="width: <?php echo e($profileCompletion['percentage']); ?>%"
                                 aria-valuenow="<?php echo e($profileCompletion['percentage']); ?>" 
                                 aria-valuemin="0" 
                                 aria-valuemax="100">
                            </div>
                        </div>
                        <strong class="text-primary"><?php echo e($profileCompletion['percentage']); ?>%</strong>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-6 mb-2">
                            <div class="d-flex align-items-center">
                                <i class="bi bi-<?php echo e($completed ? 'check-circle-fill text-success' : 'circle text-muted'); ?> me-2"></i>
                                <small class="<?php echo e($completed ? 'text-dark' : 'text-muted'); ?>">
        ...
        <div class="col-lg-6 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <?php $__currentLoopData = $contentTypeStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <span class="fw-medium"><?php echo e($type['type']); ?></span>
                            <span class="text-muted"><?php echo e($type['active']); ?>/<?php echo e($type['total']); ?></span>
                        </div>
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar" 
                                 style="width: <?php echo e($type['total'] > 0 ? ($type['active'] / $type['total']) * 100 : 0); ?>%; background-color: <?php echo e($type['color']); ?>"
                                 role="progressbar">
                            </div>
                        </div>
                    </div>
