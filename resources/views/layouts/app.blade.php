...
<head>
    ...
    @if(isset($pageUser) && isset($currentUser) && $currentUser && $currentUser->id === $pageUser->id)
        ...
        @vite(['resources/css/photo-editor.css', 'resources/js/photo-editor.js'])
...
<body>
                ...
                <div class="container nowrap">
                    ...
                    @auth
                        ...
                        <div class="navbar-nav ms-auto">
                            <a class="nav-link" href="{{ route('admin.analytics', ['user' => auth()->id()]) }}" title="Мой кабинет">
                                <i class="bi bi-gear me-1"></i>
                                <span class="d-none d-md-inline">Мой кабинет</span>
                            </a>
                            <a class="nav-link" href="{{ route('user.show', ['username' => auth()->user()->username]) }}" title="Моя страница">
                            ...
                            <div class="banner-post-header">
                                <div class="banner-post-author">
                                    ...
                                    <div class="banner-author-info">
                                        <h5 id="bannerAuthorName" class="mb-0">{{ $pageUser->name ?? 'Автор' }}
                                        </h5>
                            ...
                            <div class="service-post-header">
                                <div class="service-post-author">
                                    ...
                                    <div class="service-author-info">
                                        <h5 id="serviceAuthorName" class="mb-0">{{ $pageUser->name ?? 'Автор' }}
                                        </h5>
    ...
    <script>
            ...
            document.querySelectorAll('.banners-banner').forEach(banner => {
                ...
                banner.addEventListener('click', function() {
                    ...
                    @if (isset($pageUser))
                        if (authorAvatar) {
                            authorAvatar.src =
                                "{{ $pageUser->avatar ? asset('storage/' . $pageUser->avatar) : asset('/hero.png') }}";
                        }
                        if (authorName) {
        ...
        function generateQRCode() {
            ...
            const pageUrl = "{{ route('user.show', ['username' => auth()->user()->username]) }}";
        ...
        function downloadQRCode() {
            ...
            try {
                ...
                link.download = 'qr-code-{{ auth()->user()->username }}.png';
                    ...
                    <div class="qr-container">
                        <div class="qr-code-wrapper">
                            ...
                            <div class="qr-avatar-container">
                                <img src="{{ auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar) : asset('/hero.png') }}" 
                     ...
                     <div class="qr-info">
                            <h3 class="qr-user-name">{{ auth()->user()->name }}</h3>
                         
                            <div class="qr-url">
                                <input type="text" class="form-control qr-url-input" 
                                       value="{{ route('user.show', ['username' => auth()->user()->username]) }}" 
                                       readonly id="pageUrl">
