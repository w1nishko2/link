...
<script type="application/ld+json">
{
    ...
    "author": {
        ...
        "url": "<?php echo e(route('user.page', $article->user->username)); ?>"
    },
    "publisher": {
        "@type": "Organization",
    ...
    "itemListElement": [
        {
            ...
            "position": 1,
            "name": "<?php echo e($article->user->name); ?>",
            "item": "<?php echo e(route('user.page', $article->user->username)); ?>"
        },
        {
            "@type": "ListItem",
            "position": 2,
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(route('user.page', $article->user->username)); ?>" class="text-decoration-none">
                                    <i class="bi bi-house-door me-1"></i><?php echo e($article->user->name); ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2 text-center">
                                    <?php if($article->user->avatar): ?>
                                        <img src="<?php echo e(asset('storage/' . $article->user->avatar)); ?>" alt="Аватар <?php echo e($article->user->name); ?>" class="rounded-circle" width="80" height="80" itemprop="image">
                                    <?php else: ?>
                                ...
                                <div class="col-md-8">
                                    <h5 class="card-title" itemprop="name"><?php echo e($article->user->name); ?></h5>
                                    <?php if($article->user->bio): ?>
                                        <p class="card-text" itemprop="description"><?php echo e($article->user->bio); ?></p>
                                    <?php endif; ?>
                                    <meta itemprop="url" content="<?php echo e(route('user.page', $article->user->username)); ?>">
                                </div>
                                <div class="col-md-2 text-end">
                                    <a href="<?php echo e(route('user.page', $article->user->username)); ?>" class="btn btn-primary">
                                        Все статьи автора
                                    </a>
                                </div>
                            </div>
