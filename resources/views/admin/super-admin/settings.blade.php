                ...
                <form>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="site_name" value="{{ config('app.name') }}" disabled>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="app_env" class="form-label">Окружение</label>
                            <input type="text" class="form-control" id="app_env" value="{{ config('app.env') }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="app_url" value="{{ config('app.url') }}" disabled>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="app_timezone" class="form-label">Часовой пояс</label>
                            <input type="text" class="form-control" id="app_timezone" value="{{ config('app.timezone') }}" disabled>
                        </div>
                    </div>
                    
                    <div class="mb-3">
                        <label for="max_upload_size" class="form-label">Максимальный размер загружаемых файлов</label>
                        <input type="text" class="form-control" id="max_upload_size" value="{{ ini_get('upload_max_filesize') }}" disabled>
                    </div>
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <span class="text-muted">{{ config('session.driver') }}</span>
                </div>
            </div>
        </div>
    </div>
