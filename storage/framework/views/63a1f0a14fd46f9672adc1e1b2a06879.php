<form action="<?php echo e(route('admin.profile.update.images', $user->id)); ?>" method="POST" enctype="multipart/form-data" id="images-form">
    <?php echo csrf_field(); ?>
    ...
    <div class="mb-4">
        ...
        <div class="image-preview-container position-relative" style="height: 300px; border-radius: 16px; overflow: hidden; border: 2px dashed #dee2e6; transition: all 0.3s ease;">
            ...
            <div class="background-area position-absolute w-100 h-100" 
                 style="cursor: pointer; background-image: url('<?php echo e($user->background_image ? asset('storage/' . $user->background_image) : '/hero.png'); ?>'); 
            ...
            <div class="avatar-area position-absolute" 
                 style="bottom: 20px; right: 20px; width: 120px; height: 120px; 
                        ...
                        background-image: url('<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : '/hero.png'); ?>'); 
                        background-size: cover; background-position: center;"
        ...
        <!-- Ошибки валидации -->
        <?php if($errors->has('avatar') || $errors->has('background_image')): ?>
            <div class="mt-3">
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="alert alert-danger d-flex align-items-center">
                        ...
                        <strong>Ошибка аватара:</strong> <?php echo e($message); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="alert alert-danger d-flex align-items-center">
                        <i class="bi bi-exclamation-triangle me-2"></i>
                        <strong>Ошибка фона:</strong> <?php echo e($message); ?>
...
</form><?php /**PATH C:\OSPanel\domains\link\resources\views/admin/profile/images.blade.php ENDPATH**/ ?>